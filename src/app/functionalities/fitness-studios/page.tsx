    ...
    <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl font-bold text-white mb-6">
              <span className="text-red-500">Fitness Studios</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Espacios equipados con tecnología de última generación para tu entrenamiento perfecto.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/51978381334?text=Hola Chepa, me interesa conocer los Fitness Studios."
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-red-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">¿Listo para entrenar en nuestros studios?</h2>
          <p className="text-xl mb-8 text-red-100">
            Descubre nuestras instalaciones premium y equipos de última generación
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/51978381334?text=Hola Chepa, quiero conocer más sobre los Fitness Studios."
              target="_blank"
