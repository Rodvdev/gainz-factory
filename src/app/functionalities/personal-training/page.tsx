...
import { Dumbbell, Clock, Users, Target, CheckCircle, Phone, MessageSquare } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Diseñamos rutinas específicas para tus metas individuales"
    },
    {
      icon: Clock,
      title: "Horarios Flexibles",
      description: "Adaptamos las sesiones a tu disponibilidad y estilo de vida"
    },
    {
      icon: Users,
      title: "Seguimiento Individual",
      description: "Acompañamiento personalizado en cada paso de tu transformación"
    },
    {
      icon: CheckCircle,
      title: "Técnica Perfecta",
      description: "Aprendizaje correcto de movimientos para maximizar resultados y prevenir lesiones"
    }
  ];
  ...
  const programs = [
    {
      ...
      whatsappMessage: "Hola Chepa, me interesa el Plan Básico de Personal Training (S/ 199/mes)."
    },
    {
      name: "Plan Premium",
      price: "S/ 399",
      period: "mes",
      description: "Para resultados acelerados y seguimiento intensivo",
      features: [
      ...
      whatsappMessage: "Hola Chepa, me interesa el Plan Premium de Personal Training (S/ 399/mes)."
    },
    {
      name: "Plan VIP",
      price: "S/ 699",
      period: "mes",
      description: "Transformación completa con entrenador dedicado",
      features: [
        "Sesiones ilimitadas",
      ...
      whatsappMessage: "Hola Chepa, me interesa el Plan VIP de Personal Training (S/ 699/mes)."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl font-bold text-white mb-6">
              <span className="text-red-500">Personal Training</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Entrenamiento personalizado adaptado a tus objetivos, nivel físico y disponibilidad. 
              Maximiza tus resultados con la guía de un experto.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/51978381334?text=Hola Chepa, me interesa el Personal Training. ¿Podemos agendar una consulta?"
      ...
      <section className="py-20 bg-gray-800/50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">¿Por qué elegir Personal Training?</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Beneficios exclusivos que solo obtienes con entrenamiento personalizado
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-bold text-white mb-4">Planes de Personal Training</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {programs.map((program, index) => (
              <div
                key={index}
                className={`p-8 rounded-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl ${
                  program.name === "Plan Premium"
                    ? 'bg-gradient-to-br from-red-600 to-red-700 border-2 border-red-500'
                    : 'bg-gray-800/60 backdrop-blur-sm border border-white/10 hover:border-white/30'
                }`}
              >
                {program.name === "Plan Premium" && (
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="mb-4">
                    ...
                    <span className="text-gray-300">/{program.period}</span>
                  </div>
                ...
                <a
                  href={`https://wa.me/51978381334?text=${encodeURIComponent(program.whatsappMessage)}`}
                  target="_blank"
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-red-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-red-100">
            Agenda una consulta gratuita y descubre cómo el Personal Training puede cambiar tu vida
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://wa.me/51978381334?text=Hola Chepa, quiero agendar una consulta gratuita para Personal Training."
              target="_blank"
              rel="noopener noreferrer"
